...
void (window.tempExt = {
    Extension: class {
        constructor(e) {
            this.objectList = {}, this.runtime = e, this.canvas = () => {
                try {
                    const {
                        canvas: e
                ...
                n(init.prototype, j.prototype), init.prototype.create = function (e) {
                ...
                }, init.prototype.setElement = function (e) {
                    if (e = this.element, !e) throw new Error("[Cube]\u672A\u6307\u5B9A\u5143\u7D20");
                    this.setCanvas(e)
                }, init.prototype.setSize = function (e, t) {
                    e = Math.round(e), t = Math.round(t), this.setSizeCanvas(e, t)
                }, init.prototype.setResize = function (e) {
                ...
                }, init.prototype.onWindowResize = function () {
                    this.setMeasuredSize(), this.onResize(this.width, this.height)
                }, init.prototype.setMeasuredSize = function () {
                    ...
                    this.setSize(t, a)
                }, init.prototype.renderGraph = function (e) {
                    this.renderGraphCanvas(e)
                }, init.prototype.updateRenderGraph = function (e) {
                    this.updateGraph(), this.renderGraph(e)
                }, init.prototype.setCanvas = function (e) {
                    this.element = e, this.ctx = this.element.getContext("2d"), this.setSizeCanvas(e.width, e.height)
                }, init.prototype.setSizeCanvas = function (t, a) {
                    ...
                    this.ctx.restore()
                }, init.prototype.setDragRotate = function (e) {
                    e && (!0 === e && (e = this), this.dragRotate = e, this.bindDrag(this.element))
                }, init.prototype.dragStart = function () {
                ...
                }, init.prototype.dragMove = function (r, o) {
                ...
                custom.prototype.create = function (e) {
                ...
                custom.prototype.updatePath = function () {
                    this.setPath(), this.updatePathCommands()
                }, custom.prototype.setPath = function () {
                }, custom.prototype.updatePathCommands = function () {
                    let a;
                ...
                }, custom.prototype.updateSortValue = function () {
                    ...
                    this.sortValue = d / t
                }, custom.prototype.render = function (e, t) {
                ...
                }, custom.prototype.renderCanvasDot = function (t) {
                ...
                let roundedEect = custom.subclass({
                    width: 1,
                    height: 1,
                    cornerRadius: .25,
                    closed: !1
                });
                roundedEect.prototype.setPath = function () {
                    let o = this.width / 2,
                        d = this.height / 2,
                        l = Math.min(o, d),
                ...
                let hemisphere = ellipse.subclass({
                    fill: !0
                });
                hemisphere.prototype.create = function () {
                    ellipse.prototype.create.apply(this, arguments), this.apex = new a({
                        addTo: this,
                        translate: {
                            z: this.diameter / 2
                        }
                ...
                }, hemisphere.prototype.render = function (a, e) {
                    this.renderDome(a, e), ellipse.prototype.render.apply(this, arguments)
                }, hemisphere.prototype.renderDome = function (o, d) {
                    if (this.visible) {
                ...
                let f = ellipse.subclass();
                f.prototype.copyGraph = s;
                let cylinder = custom.subclass({
                    diameter: 1,
                    length: 1,
                    frontFace: void 0,
                    fill: !0
                ...
                cylinder.prototype.create = function () {
                    custom.prototype.create.apply(this, arguments), this.group = new g({
                        addTo: this,
                        color: this.color,
                    ...
                    let t = "_" + e;
                    Object.defineProperty(cylinder.prototype, e, {
                        get: function () {
                            return this[t]
                        },
                        set: function (a) {
                ...
                }, cone.prototype.render = function (a, e) {
                    this.renderConeSurface(a, e), ellipse.prototype.render.apply(this, arguments)
                }, cone.prototype.renderConeSurface = function (d, l) {
                    if (this.visible) {
                ...
                }, cone.prototype.setSurfaceRenderPoint = function (e, t) {
                ...
                let box = a.subclass(Z);
                return box.prototype.create = function (e) {
                    ...
                    let t = "_" + e;
                    Object.defineProperty(box.prototype, e, {
                        get: function () {
                            return this[t]
                        },
                        set: function (a) {
                ...
                }), box.prototype.setFace = function (t, a) {
                    let r = t + "Rect",
                        o = this[r];
                ...
                }, box.prototype.getFaceOptions = function (t) {
                    return {
                        frontFace: {
                            width: this.width,
                            height: this.height,
                    ...
                    let a = "_" + t;
                    Object.defineProperty(box.prototype, t, {
                        get: function () {
                            return this[a]
                        },
                        set: function (l) {
        ...
        createRect(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.rect({
                width: +args.width,
                height: +args.height,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                translate: {
                    x: +args.x,
                    y: +args.y,
                    z: +args.z
                }
            }), this.cubeScene.addChild(this.objectList[args.id]))
        }

        createRoundedRect(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.roundedRect({
                width: +args.width,
                height: +args.height,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createCircle(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.ellipse({
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createPolygon(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.polygon({
                sides: +args.sides,
                radius: +args.sides,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createHemisphere(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.hemisphere({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                backface: (() => /^#([0-9a-f]{6})$/i.test(args.backface) ? args.backface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                translate: {
                    x: +args.x,
                    y: +args.y,
                    z: +args.z
        ...
        createCone(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.cone({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                length: +args.length,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
        ...
        createCylinder(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.cylinder({
                diameter: +args.diameter,
                stroke: +args.stroke / 100,
                length: +args.length,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                backface: (() => /^#([0-9a-f]{6})$/i.test(args.backface) ? args.backface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                frontFace: (() => /^#([0-9a-f]{6})$/i.test(args.frontface) ? args.frontface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                translate: {
                    x: +args.x,
                    y: +args.y,
                    z: +args.z
        ...
        createBox(args) {
            null !== this.canvas() && null !== this.cubeParent() && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.box({
                width: +args.width,
                height: +args.height,
                depth: +args.depth,
                stroke: +args.stroke / 100,
                length: +args.length,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                leftFace: (() => /^#([0-9a-f]{6})$/i.test(args.leftface) ? args.leftface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                rightFace: (() => /^#([0-9a-f]{6})$/i.test(args.rightface) ? args.rightface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                topFace: (() => /^#([0-9a-f]{6})$/i.test(args.topface) ? args.topface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                bottomFace: (() => /^#([0-9a-f]{6})$/i.test(args.bottomface) ? args.bottomface : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                translate: {
                    x: +args.x,
                    y: +args.y,
                    z: +args.z
        ...
        createCustom(args) {
            null !== this.canvas() && null !== this.cubeParent() && "{}" !== args.path && (void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0), this.objectList[args.id] = new this.Cube.custom({
                stroke: +args.stroke / 100,
                color: (() => /^#([0-9a-f]{6})$/i.test(args.color) ? args.color : "#" + Math.floor(16777215 * Math.random()).toString(16))(),
                path: (() => {
                    let e = this.runtime.getGandiAssetsFileList().map(t => t.fullName);
                    return "fileListEmpty" == args.path | -1 == e.indexOf(args.path) | !Array.isArray(args.path) ? [] : JSON.parse((r => {
                        let e = "";
                        for (let t = 0; t < r.length; t++) e += String.fromCharCode(r[t]);
                        return e
                    })(this.runtime.getGandiAssetById(args.path).asset.data))
                })(),
                translate: {
                    x: +args.x,
                    y: +args.y,
        ...
        deleteObject(args) {
            null !== this.cubeParent() && void 0 !== this.objectList[args.id] && (this.cubeScene.removeChild(this.objectList[args.id]), this.objectList[args.id] = void 0)
        }
        ...
        getAttrib(args) {
            if (void 0 !== typeof this.objectList[args.id]) switch (args.type) {
                case "x":
                    return "undefined" == typeof this.objectList[args.id].translate.x ? "" : this.objectList[args.id].translate.x;
                case "y":
                    return "undefined" == typeof this.objectList[args.id].translate.y ? "" : this.objectList[args.id].translate.y;
                case "z":
                    return "undefined" == typeof this.objectList[args.id].translate.z ? "" : this.objectList[args.id].translate.z;
                case "width":
                    return "undefined" == typeof this.objectList[args.id].width ? "" : this.objectList[args.id].width;
                case "height":
                    return "undefined" == typeof this.objectList[args.id].height ? "" : this.objectList[args.id].height;
                case "color":
                    return "undefined" == typeof this.objectList[args.id].color ? "" : this.objectList[args.id].color;
                case "stroke":
                    return "undefined" == typeof this.objectList[args.id].stroke ? "" : this.objectList[args.id].stroke;
                case "quarters":
                    return "undefined" == typeof this.objectList[args.id].quarters ? "" : this.objectList[args.id].quarters;
                case "cornerRadius":
                    return "undefined" == typeof this.objectList[args.id].cornerRadius ? "" : this.objectList[args.id].cornerRadius;
                case "radius":
                    return "undefined" == typeof this.objectList[args.id].radius ? "" : this.objectList[args.id].radius;
                default:
                    return "";
            }
        }
        ...
        setRotate(args) {
            if (void 0 !== typeof this.objectList[args.id]) switch (args.type) {
                case "x":
                    this.objectList[args.id].rotate.x = +args.rotate * (Math.PI / 180);
                    break;
                case "y":
                    this.objectList[args.id].rotate.y = +args.rotate * (Math.PI / 180);
                    break;
                case "z":
                    this.objectList[args.id].rotate.z = +args.rotate * (Math.PI / 180);
                default:
            }
        }
    ...
    l10n: {
        "zh-cn": {
            "Cube.name": "LazyTong的立方体 V1.0.2",
            "Cube.description": "添加立体图形！"
        },
        en: {
            "Cube.name": "LazyTong's Cube V1.0.2",
